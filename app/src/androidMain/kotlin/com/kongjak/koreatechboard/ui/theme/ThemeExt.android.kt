...
actual fun fixedDynamicLightColorScheme(
    context: Any
) = lightColorScheme(
...
@RequiresApi(Build.VERSION_CODES.S)
actual fun fixedDynamicDarkColorScheme(
    context: Any
) = darkColorScheme(
...
internal fun getColor(context: Any, resId: Int): Color {
    return Color((context as Context).getColor(resId))
}