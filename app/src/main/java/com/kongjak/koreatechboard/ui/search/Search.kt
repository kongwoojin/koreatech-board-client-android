...
fun SearchScreen(site: String, board: String, title: String) {
    ...
    Scaffold(
        ...
        content = { contentPadding ->
            SearchContent(contentPadding = contentPadding, site = site, board = board, title = title)
        }
    )
}

@Composable
fun SearchContent(searchViewModel: SearchViewModel = hiltViewModel(), contentPadding: PaddingValues, site: String, board: String, title: String) {
    val context = LocalContext.current
